...
editsaveBtn.onclick = function(){
    if (editsaveBtn.innerHTML === "Edit"){
        ...
        document.getElementById("author").style.border = 0;
...
function myFunction() {
    ...
    y = Date()
    document.getElementById("commentSection").innerHTML = '<p id="para" class = "commentPara">'+x+"<pre>      commented on: "+ Date()+"</pre>"+'</p>' + document.getElementById("commentSection").innerHTML;
}